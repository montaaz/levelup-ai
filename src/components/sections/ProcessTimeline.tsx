...
const STEPS = [
  { title: "Discover", copy: "We understand your business, audience, offer, and the result you need." },
  { title: "Shape", copy: "We define the right scope, creative direction, message, and project plan." },
  { title: "Build", copy: "We create, test, and refine the experience with your feedback." },
  { title: "Launch", copy: "We deliver the final project, explain how it works, and help you move forward." },
];
